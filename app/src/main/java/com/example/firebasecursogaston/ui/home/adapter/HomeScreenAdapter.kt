package com.example.firebasecursogaston.ui.home.adapter
...
import com.example.firebasecursogaston.core.BaseViewHolder
import com.example.firebasecursogaston.core.TimeUtils
import com.example.firebasecursogaston.data.model.Post
import com.example.firebasecursogaston.databinding.PostItemViewBinding
    ...
    private inner class HomeScreenViewHolder(
        ...
        private fun tintHeartIcon(post: Post) {
            if(!post.liked) {
                ...
                binding.likeBtn.setColorFilter(ContextCompat.getColor(context, R.color.purple_200))
            } else {
